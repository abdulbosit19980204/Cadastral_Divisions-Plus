...
if settings.value('locale/userLocale')[0:2] == 'it':
    Help_0 = "Fraziona il poligono interessato in parti in funzione di una linea<br>\
        ...
        <li>modalità di gestione dell'area residua</li>\
        </ol>\
    ...
    desc_0 = 'Frazionamenti Catastali Plus'
    ...
    feed_9 = 'parti '
    desc_9 = 'Modalità area residua'
    desc_10 = 'Indice parte per il residuo (1 = prima)'
    res_mode_last = 'Aggiungi il residuo all\'ultima parte'
    ...
    feed_9 = 'partes '
    desc_9 = 'Modo de manejo del residuo'
    desc_10 = 'Número de parte para el residuo (1 = primera)'
    res_mode_last = 'Agregar residuo a la última parte'
    ...
    label_residual = 'sub residuo'
elif settings.value('locale/userLocale')[0:2] == 'ru':
    Help_0 = "Делит полигон на части по выбранной линии<br>\
            Создаёт новый слой под названием 'Fraz_' с датой и временем\n\
            <h3 style='color:blue'><strong>Параметры</strong></h3>\
            <ul>\
            <li>полигональный слой с <b>участками для деления</b></li>\
            <li>линейный слой с <b>линией направления разреза</b></li>\
            <li><b>знаменатель доли или число равных частей <font color='green'>[опц. 2]</font></b></li>\
            </ul>\
            <h3 style='color:green'><strong>Опции</strong></h3>\
            <ol>\
            <li>разрез по вручную размещённой линии</li>\
            <li>деление на равные части</li>\
            <li>целевая площадь вместо долей</li>\
            <li>инверсия порядка частей</li>\
            <li>способ обработки остаточной площади</li>\
            </ol>\
            <h4 style='color:red'>НЕПРЕДСКАЗУЕМЫЙ РЕЗУЛЬТАТ ДЛЯ ВОГНУТЫХ ПОЛИГОНОВ</h4>\
            <h4 style='color:black'>Подробнее:</h4>\
            <h5 style='color:blue'><a href='https://github.com/Korto19/Cadastral_Divisions#frazionamenti-cadastral-divisions'>https://github.com/Korto19/Cadastral_Divisions#frazionamenti-cadastral-divisions</a></h5>"
    desc_0 = 'Кадастровые деления Plus'
    desc_1 = 'Входной полигональный слой'
    desc_2 = 'Входной линейный слой'
    desc_3 = 'Разрезать вручную размещённой линией'
    desc_4 = 'Знаменатель доли или 1/n площади'
    desc_5 = 'Деление на равные части'
    desc_6 = 'Целевая площадь вместо доли'
    desc_7 = 'Инвертировать части относительно линии (верх/низ - лево/право)'
    desc_8 = 'FractPlus_'
    field_1 = 'Chast_sub'
    field_2 = 'Chast_dolya'
    field_3 = 'Chast_plosh'
    msg_1 = "1 !! ЛИНИЯ КАСАЕТСЯ, НО НЕ ПЕРЕСЕКАЕТ ПОЛИГОН !!"
    msg_2 = "2 !! ЛИНИЯ КАСАЕТСЯ, НО НЕ ПЕРЕСЕКАЕТ ПОЛИГОН !!"
    msg_3 = "!! ЛИНИЯ НЕ ПЕРЕСЕКАЕТ ПОЛИГОН !!"
    msg_4 = "ЦЕЛЕВАЯ ПЛОЩАДЬ БОЛЬШЕ ПОЛНОЙ"
    feed_1 = ' разрезов --- остаток = '
    feed_2 = 'остаток = '
    feed_3 = 'Прямой разрез'
    feed_4 = 'Деление пополам'
    feed_5 = 'Разрез по заданной площади'
    feed_6 = 'Разрез 1/'
    feed_7 = ' и '
    feed_8 = 'Разрезы по схеме n 1/n'
    feed_9 = 'частей '
    desc_9 = 'Режим обработки остатка'
    desc_10 = 'Номер части для остатка (1 = первая)'
    res_mode_last = 'Добавить остаток к последней части'
    ...
    label_residual = 'sub ostatok'
elif settings.value('locale/userLocale')[0:2] == 'uz':
    Help_0 = "Poligonni berilgan chiziq bo'yicha qismlarga bo'ladi<br>\
            Natijada sana-vaqt qo'shilgan 'Fraz_' nomli yangi qatlam yaratiladi\n\
            <h3 style='color:blue'><strong>Parametrlar</strong></h3>\
            <ul>\
            <li><b>bo'linadigan elementlar</b> saqlangan poligon qatlami</li>\
            <li><b>bo'luvchi chiziq</b> saqlangan liniya qatlami</li>\
            <li><b>kasr maxraji yoki teng bo'laklar soni <font color='green'>[opt 2]</font></b></li>\
            </ul>\
            <h3 style='color:green'><strong>Opsiyalar</strong></h3>\
            <ol>\
            <li>qo'lda joylashtirilgan chiziq bilan kesish</li>\
            <li>n ta teng bo'lakka ajratish</li>\
            <li>maqsad yuzasini ko'rsatish (bo'laklar o'rniga)</li>\
            <li>bo'laklarning tartibini chiziqqa nisbatan ag'darish</li>\
            <li>ortib qolgan qoldiqni boshqarish usuli</li>\
            </ol>\
            <h4 style='color:red'>ICHKARI KAVSHAR POLIGONLARDA NATIJA NOANIQ</h4>\
            <h4 style='color:black'>Qo'shimcha ma'lumot:</h4>\
            <h5 style='color:blue'><a href='https://github.com/Korto19/Cadastral_Divisions#frazionamenti-cadastral-divisions'>https://github.com/Korto19/Cadastral_Divisions#frazionamenti-cadastral-divisions</a></h5>"
    desc_0 = 'Kadastr bo\'linmalari Plus'
    desc_1 = 'Kiritish poligon qatlami'
    desc_2 = 'Kiritish chiziq qatlami'
    desc_3 = 'Qo\'lda joylashgan chiziq bilan kesish'
    desc_4 = 'Kasr maxraji yoki 1/n yuzasi'
    desc_5 = 'Teng bo\'laklarga ajratish'
    desc_6 = 'Kasr o\'rniga maqsad yuzasi'
    desc_7 = 'Bo\'lak tartibini chiziqqa nisbatan ag\'darish'
    desc_8 = 'FractPlus_'
    field_1 = 'Bolak_sub'
    field_2 = 'Bolak_ulush'
    field_3 = 'Bolak_mayd'
    msg_1 = "1 !! CHIZIQ POLIGONNI FAQAT TEGINADI, LEKIN KESMAYDI !!"
    msg_2 = "2 !! CHIZIQ POLIGONNI FAQAT TEGINADI, LEKIN KESMAYDI !!"
    msg_3 = "!! CHIZIQ POLIGONNI KESMADI !!"
    msg_4 = "MAQSAD YUZA UMUMIYDAN KATTA"
    feed_1 = ' kesish --- qoldiq = '
    feed_2 = 'qoldiq = '
    feed_3 = 'Bevosita kesish'
    feed_4 = 'Ikki teng qismga bo\'lish'
    feed_5 = 'Maqsad yuzaga ko\'ra kesish'
    feed_6 = '1/ bo\'yicha kesish'
    feed_7 = ' va '
    feed_8 = 'n 1/n rejasidagi kesishlar'
    feed_9 = 'bo\'lak '
    desc_9 = 'Qoldiqni boshqarish usuli'
    desc_10 = 'Qoldiq qo\'shiladigan bo\'lak raqami (1 dan)'
    res_mode_last = 'Qoldiqni oxirgi bo\'lakka qo\'shish'
    ...
    feed_9 = 'parts ' 
    desc_9 = 'Residual handling mode'
    desc_10 = 'Residual target part (1 = first)'
    res_mode_last = 'Append residual to last part'
    ...
    label_residual = 'sub residual'


class  CadastralDivisionsPlusAlgorithm(QgsProcessingAlgorithm):
    """
    ...
    INPUTR = 'INPUTR'       #gestione residuo
    INPUTRI = 'INPUTRI'     #indice parte residuo
    ...
    def createInstance(self):
        return  CadastralDivisionsPlusAlgorithm()
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        residual_mode = self.parameterAsEnum(
            parameters,
            self.INPUTR,
            context)
        
        residual_index = self.parameterAsInt(
            parameters,
            self.INPUTRI,
            context)
        if residual_index < 1:
        ...
        for f in sourceP.getFeatures():
            ...
            base_attributes = f.attributes()
        if mappale is None:
            sys.exit("!! NESSUNA GEOMETRIA POLIGONALE !!")
            
        dividente = None
        for f in sourceL.getFeatures():
            dividente = f
        if dividente is None:
            sys.exit("!! NESSUNA GEOMETRIA LINEARE !!")
        ...
        if not frazioni or ( frazioni and parti==2):
            ...
            while parti > 2:
                ...
                rlist = nnsezione(dividente, mappale, parti, decimali, val_prec, iterazioni, verso, sup_target)
                output_parts.append({
                    'geometry': rlist[3].geometry().clone(),
                    'area': rlist[4],
                    'label': 'sub ' + str(int(parti))
                })
                mappale = rlist[0]
                parti -= 1
        ...
        if 'rlist' in locals():
            for idx in (0, 3):
                if idx >= len(rlist):
                    continue
                label_value = 'sub ' + str(int(idx//3 + 1))
                output_parts.append({
                    'geometry': rlist[idx].geometry().clone(),
                    'area': rlist[idx+1],
                    'label': label_value
                })

        residual_part = None
        if sup_target > 0 and output_parts:
            last_part = output_parts[-1]
            residual_gap = sup_target - last_part['area']
            threshold = max(val_prec, sup_target * 0.001)
            if residual_gap > threshold:
                residual_part = output_parts.pop()
        ...
        if residual_part:
            ...
            if residual_mode == 0 and output_parts:
                ...
                target_index = 0
            elif residual_mode == 2 and output_parts:
                requested_index = residual_index - 1
                if 0 <= requested_index < len(output_parts):
            ...
            if target_index is not None:
                ...
                if merged is None or merged.isEmpty():
                    merged = target_part['geometry'].unaryUnion(residual_part['geometry'])
                if merged is not None and not merged.isEmpty():
                    target_part['geometry'] = merged
        ...
        for part in output_parts:
            ...
            new_feature.setGeometry(part['geometry'])
            part_attrs = list(base_attributes)
            part_attrs.append(part['label'])
            part_attrs.append(format(part['area']/area_mappale,'.2%'))
            part_attrs.append(format(part['area'],str_decimali))
            new_feature.setAttributes(part_attrs)
